package com.example.Alharm.alharm.Path;
...
// تقوم بتحديد الطرق بين موقع العميل وموقع المتخصص لرسم المسار بينهما
...
public class drawPath {
    ...
    public static class FetchUrl extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            drawPath.ParserTask parserTask = new drawPath.ParserTask();
